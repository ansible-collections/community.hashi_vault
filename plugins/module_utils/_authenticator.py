...
class HashiVaultAuthenticator():
    ARGSPEC = dict(
        ...
        token_path=dict(type='str', default=None),
        ...
        aws_access_key=dict(type='str', aliases=['aws_access_key_id']),
        aws_secret_key=dict(type='str', aliases=['aws_secret_key_id'], no_log=True),
        aws_security_token=dict(type='str'),
